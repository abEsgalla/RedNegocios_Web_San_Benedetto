...
<? if(!$args['page_id']): ?>
  <section>
    <div class="container-fluid position-relative zi-9 <?/*bg-black*/?>">
      ...
      <div class="opacity-100 background-producto zi-75 background-position-left-mobile bg-custom-image w-100 h-100 position-absolute top-0 start-0"
        style="background:url('<?=wp_get_attachment_image_url(get_field('fondo_cabecera',585), "full")?>')">
      </div>

      <div class="opacity-0 background-procesos zi-75 background-position-left-mobile bg-custom-image w-100 h-100 position-absolute top-0 start-0"
