...
<section class="mt-120 mt-sm-166 mt-lg-218 gx-4 gx-sm-12">
  <div class="container position-relative zi-99">
    <div class="row">
      ...
      <div class="col-12 col-lg-6 gx-0 img-version-mobile overflow-hidden">
        <div class="w-100 bg-custom-image py-200 py-sm-422 position-relative d-none d-lg-block" 
          style="background:url('<?=wp_get_attachment_image_url(1338, "full")?>')">
          <svg class="svg-road-localizacion-l position-absolute mw-100" xmlns="http://www.w3.org/2000/svg" width="572" height="605" viewBox="0 0 572 605" fill="none">
          ...
          <svg class="svg-road-localizacion-r position-absolute mw-100" xmlns="http://www.w3.org/2000/svg" width="497" height="720" viewBox="0 0 497 720" fill="none">
        ...
        <div class="w-100 bg-custom-image py-200 py-sm-422 position-relative d-none d-md-block d-lg-none" 
          style="background:url('<?=wp_get_attachment_image_url(1339, "full")?>')">
          <svg class="svg-road-localizacion-l position-absolute mw-100" xmlns="http://www.w3.org/2000/svg" width="590" height="604" viewBox="0 0 590 604" fill="none">
          ...
          <svg class="svg-road-localizacion-r position-absolute mw-100" xmlns="http://www.w3.org/2000/svg" width="521" height="720" viewBox="0 0 521 720" fill="none">
        ...
        <div class="w-100 bg-custom-image py-200 py-sm-422 position-relative d-block d-md-none" 
          style="background:url('<?=wp_get_attachment_image_url(1342, "full")?>')">
          <svg class="svg-road-localizacion-l position-absolute mw-100" xmlns="http://www.w3.org/2000/svg" width="270" height="289" viewBox="0 0 270 289" fill="none">
          ...
          <svg class="svg-road-localizacion-r position-absolute mw-100" xmlns="http://www.w3.org/2000/svg" width="237" height="340" viewBox="0 0 237 340" fill="none">
      ...
      <div class="col-12 col-lg-6 bg-secondary"> 
        <div class="row px-sm-0 px-12">
          <div class="col-12 offset-sm-2 col-sm-8 offset-lg-1 col-lg-6">
            <form class="my-48 my-sm-64 my-lg-80 text-white rm-bootstrap-form-style needs-validation" novalidate>
              <div class="mt-3">
