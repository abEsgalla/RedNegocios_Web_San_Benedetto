...
<section class="position-absolute top-0 w-100">
  <div class="container-fluid position-relative zi-9 bg-black pt-138 pb-422 pb-sm-333 pt-md-228 pb-md-533 pt-lg-261 pb-lg-533">
        ...
        <div class="row">
          <div class="col-12 offset-xl-3 col-xl-6 text-center">
            <div class="row text-white">
              ...
              <h1 class="col-12 mt-8 mt-lg-16 fs-32 fs-md-64 fs-lg-1 fw-bold text-green">
                Ecolosofía
              </h1>
            </div>
          </div>
...
<section class="mb-96 position-relative mt-custom-28 mw-custom-container">
  ...
  <div class="container bg-white">
    <div class="row text-center">
      <div class="col-12 offset-lg-2 col-lg-8 mt-138 mt-sm-200 mt-lg-176 fs-18 fs-sm-24 fs-lg-32 fw-bolder text-secondary text-uppercase">
        Del gr. οἰκο- oiko-.: Significa 'ecológico'<br>
        Del gr. φιλοσοφία philosophía.:  <span class="text-green d-block lh-1"> 
        Manera de pensar o de ver las cosas. </span>
      </div>
      <div class="col-12 offset-lg-2 col-lg-8 mt-80 mt-sm-94 mt-lg-102 text-center text-secondary fs-17">
      ...
      <div class="col-12 mt-55 mt-sm-123 gx-0 gx-lg-4">
        <div class="row text-white">
...
<section class="my-96 mb-md-108 mt-md-160 mt-xl-256 mb-xl-160">
      ...
      <div class="col-12">
        <div class="row">
          <div class="col-12 col-lg-6 order-0 order-lg-0">
            <div class="row pt-128 pt-lg-80 pb-24 pb-sm-133 pb-lg-200 bg-white">
              <div class="col-12 offset-sm-1 col-sm-10">
                <div class="row text-secondary text-uppercase">
                  <div class="mt-150 mt-sm-0 col-12 col-sm-6 col-lg-12 order-sm-0 order-1">
          ...
          <div class="col-12 col-sm-6 py-200 py-lg-0 bg-custom-image order-3 order-lg-2" 
            style="background:url('<?=wp_get_attachment_image_url(616, "full")?>')">
          </div>
          <div class="col-12 col-md-10 col-lg-6 order-1 order-lg-3">
            <div class="row position-relative pb-90 pt-0 py-lg-150">
              <div class="col-12">
                <div class="row text-center text-sm-start text-secondary fs-17">
                  <div class="col-12 offset-sm-1 col-sm-10">
