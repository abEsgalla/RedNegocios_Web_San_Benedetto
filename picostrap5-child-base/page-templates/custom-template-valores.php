      ...
      <div class="row">
        <div class="col-5">
          <div class="row text-white text-uppercase">
            ...
            <div class="col-12 fs-24 mt-48">
              Ser la Total Beverage Company que eligen las personas para hidratarse y refrescarse, 
...
<section class="my-96">
  <div class="container position-relative py-96">
    <div class="row">
      ...
      <div style="" class="g-0 col-12 col-sm-6 d-block bg-primary">
    ...
    <div class="row text-secondary">
      ...
      <div class="col-12">
        <div class="row">
          <div class="col-12">
            <div class="row">
              <div class="offset-1 col-4 mt-80">
                <div class="row">
              ...
              <div class="offset-2 col-4 mt-80">
                <div class="row">
                  <div class="col-12 fs-96 fw-bold text-primary">
                    02
                    <span>
