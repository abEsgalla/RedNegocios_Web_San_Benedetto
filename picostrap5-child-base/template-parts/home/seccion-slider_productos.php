...
foreach ($fields['productos'] as $id_producto):
  ...
  if(get_field('caracteristicas_producto',$id_producto) && get_field('caracteristicas_producto',$id_producto)["imagen_producto_destacado"]):
    ...
    <div class='contenedor-cursor-custom ratio ratio-1x1' style='background-color:".get_field('caracteristicas_producto',$id_producto)['color_corporativo']."'>"
...
<div class="col-12 mt-90 mt-xxl-0 offset-xxl-8 col-xxl-4">
  <div class="filtros_buscador row text-secondary text-start text-xxl-center text-uppercase fs-13 fw-500">
    <div class="col-2 col-xxl filtro_buscador active c-pointer" data-filter="*">
      Todos
    </div>
    <?php
      foreach ($categories_slider_html as $category_slider_html):
      ?>
      <div class="col-3 col-xxl filtro_buscador c-pointer" data-filter="<?=str_replace(' ', '-', strtolower($category_slider_html))?>">
...
<div class="col-12 mt-70">
  ...
  <div class="swiper swiper-home-dedicado">
    ...
    <div class="col-12 mt-24 mt-xxl-12 d-flex justify-content-end align-items-center">
      <div class="arrow-prev mx-12 c-pointer opacity-50" onclick=swiper_home_dedicado.slidePrev()>
      ...
      <div class="arrow-next mx-12 c-pointer" onclick=swiper_home_dedicado.slideNext()>
        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="32" viewBox="0 0 17 32" fill="none">
