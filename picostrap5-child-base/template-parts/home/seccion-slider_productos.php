...
<div class="col-12 position-relative">
  <div class="row">
    ...
    <div class="col-12 mt-48 mt-sm-90 mt-lg-0 offset-lg-7 col-lg-5 offset-xxl-8 col-xxl-4 position-xl-absolute end-0 bottom-0">
...
<div class="col-12 mt-16 mt-md-32 mt-xl-70">
  ...
  <div class="swiper swiper-home-dedicado">
    ...
    <div class="row">
      <div class="col-12 mt-24 mt-md-108 mt-xl-12 d-flex justify-content-end align-items-center">
        <div class="arrow-prev c-pointer opacity-50" onclick=swiper_home_dedicado.slidePrev()>
        ...
        <div class="arrow-next ms-24 c-pointer" onclick=swiper_home_dedicado.slideNext()>
          <svg xmlns="http://www.w3.org/2000/svg" width="17" height="32" viewBox="0 0 17 32" fill="none">
