...
foreach ($fields['slides'] as $slide):
    ...
    $slider_html.="
    <div class='swiper-slide text-".$slide['color_texto']." h-auto' data-bgcolor=".$slide['color_fondo']. " data-textcolor=".$slide['color_texto']. ">
        <div class='container-fluid'>
            <div class='container gx-4'>
                <div class='row align-items-center'>
                    ...
                    <div class='col-12 col-lg-4 mt-28 mt-sm-0 text-center'>"
...
<div class="col-12 h-875 d-flex align-items-center">
        ...
        <div class="swiper-wrapper position-relative">
            <div class='container-fluid position-absolute top-0 start-0 zi-99'>
                <div class='container gx-4'>
                    <div class='row'>
                        <div class="col-12">
                            <div class='row'></div> <!-- Tengo este apartado en slack - Jandro -->
                        </div>
                    </div>
                </div>
            </div>
...
<div class="col-12">
    <div class="container gx-4">
        <div class="row g-0">
            <div class="zi-99 col-12 d-flex justify-content-lg-start justify-content-end align-items-center position-relative"> <!-- mt-80 -->
                <div class="d-lg-flex">
