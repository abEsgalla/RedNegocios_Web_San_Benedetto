...
foreach ($fields['slides'] as $slide):
    ...
    <div class='swiper-slide text-secondary h-auto'>
        ...
        "</div>
        <div class='container-fluid zi-99 top-xxl-50 top-25 position-absolute translate-middle-y'>
            <div class='container'>
                <div class='row'>
                    <div class='col-12 col-xxl-6'>
                        <div class='row text-center text-xxl-start'>
...
<div class="col-12">
    ...
    <div class="swiper swiper-home-promocional">
        ...
        <div class="container">
            <div class="row">
                <div class="zi-99 col-12 d-flex justify-content-xxl-start justify-content-end align-items-center position-absolute bt-40">
                    <div class="d-xxl-flex">
                        <div class="arrow-prev mx-12 c-pointer opacity-50" onclick=swiper_home_promocional.slidePrev()>
                            <svg class="d-xxl-inline d-none" xmlns="http://www.w3.org/2000/svg" width="17" height="32" viewBox="0 0 17 32" fill="none">
                            ...
                            <svg class="d-xxl-none d-inline" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 33 18" fill="none">
