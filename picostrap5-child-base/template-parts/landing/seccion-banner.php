...
<? if(is_single(211)): ?>
  ...
  <section class="position-relative bg-custom-image <?=$padding?>" style="background:url('<?=wp_get_attachment_image_url($seccion['fondo'], "full")?>')">
      ...
      <div class="container">
        ...
        <? if($seccion['slider_interior']): ?>
        <div class="swiper swiper-landing-banner">
          <div class="swiper-wrapper">            
            <? foreach ($seccion['slider_interior'] as $image) {
              echo '<div class="swiper-slide text-center">';
              echo wp_get_attachment_image($image['img_slider_interior'], "full", "", array( 'class' => ''  , 'alt' => '' , 'title' => '') );
              echo '</div>';
            }
            ?>
          </div>
          <div class="zi-99 col-12 d-flex d-lg-none justify-content-end align-items-center">
              <div class="c-pointer arrow-prev <?/*opacity-50*/?>" onclick=swiper_landing_banner.slidePrev()>
              ...
              <div class="c-pointer arrow-next ms-28" onclick=swiper_landing_banner.slideNext()>
              <svg xmlns="http://www.w3.org/2000/svg" width="17" height="32" viewBox="0 0 17 32" fill="none">
