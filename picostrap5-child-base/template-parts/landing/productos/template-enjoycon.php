...
<section>
	<div class="container-fluid position-relative zi-99">
        ...
        <img src="<?=get_stylesheet_directory_uri().'/src/img/background-esjoy/fresa_1.png'; ?>" class="position-absolute fresa-1con">
        ...
        foreach ($acf_fields['secciones'] as $seccion):
            ...
            switch ($seccion['acf_fc_layout']):
                ...
                case 'imagen_ilustraciones':
                    get_template_part( 'template-parts/landing/seccion', 'imagen_ilustraciones_enjoycon', $seccion);
                break;
            endswitch;
        endforeach;
    endif;
