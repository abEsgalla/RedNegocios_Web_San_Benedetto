    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="swiper swiper-landing-productos mt-96">
          <div class="swiper-wrapper <?=(count($seccion['slider']['slide'])<=5)?'justify-content-xl-center':'';?>">
            <?php
            if ($seccion['slider']):
              ...
              <div class="px-8 w-custom-1-9 swiper-slide d-inline-flex flex-column justify-content-center align-items-center h-100">
                ...
                data-description="<?=$slide['descripcion_producto']?>">
                  ...
                  class='w-100 ratio ratio-5x7 d-flex justify-content-center align-items-center'>
                    <div class="bg-custom-post" style="background:url('<?=wp_get_attachment_image_url($slide['imagen_producto'], "full", "")?>')"></div>
                  </div>
